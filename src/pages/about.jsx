...
const About = () => (
  <div className="relative bg-[#E1DFD9] min-h-screen w-full flex flex-col items-center text-center">
    {/* Header with black nav text */}
    <Header showLogo={true} textColor="black" />

    <main className="w-full px-8 pt-40">
      {/* Who We Are Section */}
