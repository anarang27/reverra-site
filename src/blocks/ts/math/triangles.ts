...
function solveForOpposite({
  angle,
  adjacent,
  hypotenuse,
}: OppositeSolveOptions): number {
  if (typeof hypotenuse === "number") {
...
function solveForAdjacent({
  angle,
  opposite,
  hypotenuse,
}: AdjacentSolveOptions): number {
...
function solveForHypotenuse({
  angle,
  opposite,
  adjacent,
}: HypotenuseSolveOptions): number {
  if (typeof opposite === "number") {
